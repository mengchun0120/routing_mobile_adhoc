...
set tracefd [open "../trace/test863-250.tr" w]
set recfd [open "../trace/test863-250.rec" w]
...
for {set i 0} {$i < $val(nn)} {incr i} {
	...
	$node_($i) set X_ [$rngx uniform 0.0 $val(x)]
	$node_($i) set Y_ [$rngy uniform 0.0 $val(y)]
}
