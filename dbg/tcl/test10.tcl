...
set tracefd [open "$path/trace/test10.tr" w]
set recfd [open "$path/trace/test10.rec" w]
...
source "$path/scen/scen-n100-s20-x1000-y1000-t320-1"
...
proc stop {} {
	global ns_ tracefd recfd total reccount gateways
	$ns_ flush-trace
